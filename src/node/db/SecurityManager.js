 ...
 * @param {string} padID the pad the user wants to access
 * @param {string} sessionCookie the session the user has (set via api)
 * @param {string} token a random token representing the author, of the form
 *              t.randomstring_of_lenght_20. The random string is generated by
 *              the client.
 *              Used for every pad in the web UI. Not used for the HTTP API.
 * @param {string} password the password the user has given to access this pad, can be null
 * @return {accessStatus: ("grant"|"deny"|"wrongPassword"|"needPassword"), authorID: string}
 */
